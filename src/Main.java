...
//        admin.addProduct();
//        component.Product product = new component.Product();
//        File orderSession = new File("orderSession.txt");

//
//        component.Order order = new component.Order();
//        String userName = "minhhoang";
//        String[] obj = crud.ReadDataFromTXTFile.readSpecificLine(userName, 6, "./src/customers.txt", ",");
////        System.out.println(Arrays.toString(obj));
//        String[] productInfo = crud.ReadDataFromTXTFile.readSpecificLine("Dell XPS 17", 1, "./src/items.txt", ",");
//        component.Customer member = new component.Customer(obj[0], obj[1], obj[2], obj[3], obj[4], obj[5], obj[6], obj[7], Double.parseDouble(obj[8]));
//        component.Product product = new component.Product((productInfo[0]), productInfo[1], Double.parseDouble(productInfo[2]), productInfo[3]);
//        ;
//        ;
//        order.createNewOrder(member, product);
//        String[] data = crud.ReadDataFromTXTFile.readSpecificLine("C001", 1, "./src/ordersHistory.txt", ",");
...
//        order.createNewOrder(member,product);
//        ArrayList<String[]> database = crud.ReadDataFromTXTFile.readAllLines("./src/ordersHistory.txt");
...
//        crud.CreateTable createTable = new crud.CreateTable();
...
//        String[] data = crud.ReadDataFromTXTFile.readSpecificLine("C001",0,"./src/orderHistory.txt",",");
...
//        crud.ReadDataFromTXTFile.readSpecificLine("minhhoang",6,"./src/customers.txt",",");
//        String[] database = crud.ReadDataFromTXTFile.readSpecificLine("minhhoang",6,"./src/customers.txt",",");
